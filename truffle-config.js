...
module.exports = {
  ...
  networks: {
    ...
    avax: {
      provider: function() {
        return new HDWalletProvider(process.env.mnemonic, "https://rpc.ankr.com/avalanche");
      },
      network_id: "43114"
    },
    avaxtest: {
    ...
    eth: {
      provider: function() {
        return new HDWalletProvider(process.env.mnemonic, "https://mainnet.infura.io/v3/"+ process.env.infurakey);
      },
      network_id: "1"
    },
    ethropsten: {
